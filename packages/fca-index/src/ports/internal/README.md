...
Three internal port interfaces that isolate implementation details within `@fractal-co-design/fca-index`. These ports are not exported from the package public API — they exist purely to enable testing and decouple internal domains.

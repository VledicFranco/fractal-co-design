...
deprecation_note: "Use /forge-review --advisors-only instead. This skill's full body is preserved and loaded by forge-review as a redirect until the forge body is written."
...
- Advisors should have a **name, dimension, contrarian angle, and MBTI cognitive profile** that makes their perspective and reasoning style immediately clear.
...
**MBTI cognitive typing (EXP-005):** Assign each advisor an MBTI type that shapes their review *reasoning style*. This produces more diverse findings and reasoning frameworks (+34% in controlled experiments). Match cognitive functions to the review dimension:

| Review Dimension | Recommended MBTI | Why |
|-----------------|-----------------|-----|
| Security | INTJ (Ni-Te) | Strategic threat modeling, system-level attack pattern matching |
| Performance / Scale | ISTP (Ti-Se) | Concrete mechanical analysis, hands-on benchmarking instinct |
| Architecture | INTP (Ti-Ne) | Internal logical consistency, generates structural alternatives |
| Operations / Day-2 | ISTJ (Si-Te) | Precedent-based failure enumeration, systematic checklists |
| Simplicity / YAGNI | ENTP (Ne-Ti) | Challenges complexity, generates simpler alternatives |
| Data Integrity | ISFJ (Si-Fe) | Detail-oriented validation, protective of data relationships |
| Ergonomics / DX | ENFP (Ne-Fi) | User empathy, notices friction patterns, values developer joy |
...
| Advisor | Dimension | Contrarian Angle | MBTI |
|---------|-----------|-----------------|------|
| **Name** | What they review | One-line attack posture | Type (Stack) — 1-sentence reasoning style |
...
Your MBTI type is {type} ({cognitive_stack}). This shapes HOW you reason:
{1-sentence reasoning style from the cognitive functions}. Let your cognitive
functions guide your attention — what you notice first, what you push on,
what patterns you extract.

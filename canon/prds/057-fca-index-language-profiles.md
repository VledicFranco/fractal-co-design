> **Canonical FCD PRD.** Migrated from `method/docs/prds/057-fca-index-language-profiles.md` on 2026-04-25. Specifies the polyglot scanning / `LanguageProfile` work shipped in the final upstream `@methodts/fca-index@0.4.0` release; this is the same code that became `@fractal-co-design/fca-index@1.0.0` after migration. Original specification preserved verbatim — references to `@methodts/fca-index` reflect the implementation history.

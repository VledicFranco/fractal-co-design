> **Canonical FCD PRD.** Migrated from `method/docs/prds/053-fca-index-library.md` on 2026-04-25. The package was renamed `@methodts/fca-index` → `@fractal-co-design/fca-index@1.0.0` as part of the migration. Original specification preserved verbatim — references to `@methodts/fca-index` reflect the implementation history; current installs use `@fractal-co-design/fca-index`.

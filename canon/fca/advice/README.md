...
contents:
  ...
  - 02-co-design-dynamics.md
  - 03-recursive-semantic-algorithms.md
---
...
| [02 — Co-Design Dynamics](02-co-design-dynamics.md) | Multi-team platforms, distributed design | FCA's 8 parts have a dependency DAG — Port definition logically precedes Architecture. Surface quality bounds system quality multiplicatively. |
| [03 — Recursive Semantic Algorithms](03-recursive-semantic-algorithms.md) | LLM agent orchestration over codebases | FCA's self-similar structure is a recursion scheme for agent decomposition — one agent per level, same template, O(d) exploration. DRAFT — theoretical, no empirical validation. |

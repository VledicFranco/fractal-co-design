...
description: Use built-in language profiles to scan polyglot repos, or author a custom LanguageProfile for a new language ecosystem.
---

## Why language profiles?

Up to v0.3.x, `@fractal-co-design/fca-index` could only scan TypeScript projects —
